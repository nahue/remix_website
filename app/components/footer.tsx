export function Footer() {
    return (
        <div
            className='max-w-screen-xl mx-auto py-12 px-4 sm:px-6 md:flex
            md:items-center md:justify-between lg:px-8'
        >
            <div className='flex justify-center md:order-2'>
                <a
                    href='https://www.facebook.com/strato1986'
                    target='_blank'
                ...
                <a
                    href='https://www.instagram.com/nahue.86/'
                    target='_blank'
                ...
                >
                    ...
                    >
                        <path
                            ...
                            2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013
                            9.256 2 11.685 2h.63zm-.081 1.802h-.468c-2.456
                            0-2.784.011-3.807.058-.975.045-1.504.207-1.857.344-.467.182-.8.398-1.15.748-.35.35-.566.683-.748
                            1.15-.137.353-.3.882-.344 1.857-.047 1.023-.058
                            1.351-.058 3.807v.468c0 2.456.011 2.784.058
                            ...
                            3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2
                            1.2 0 010-2.4z'
                            clipRule='evenodd'
                        />
                    </svg>
                ...
                <a
                    href='https://twitter.com/nchaves1986'
                    target='_blank'
                    className='ml-6 text-gray-400 hover:text-gray-500'
                >
                    ...
                    >
                        <path
                            ...
                            8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224
                            8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743
                            11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27
                            5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0
                            003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108
                            0 003.834 2.85A8.233 8.233 0 012 18.407a11.616
                            11.616 0 006.29 1.84'
                        />
                    </svg>
                </a>
                <a
                    href='https://github.com/nahue'
                    target='_blank'
                    className='ml-6 text-gray-400 hover:text-gray-500'
                >
                    ...
                    >
                        <path
                            ...
                            .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004
                            1.705.115 2.504.337 1.909-1.296 2.747-1.027
                            2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028
                            1.595 1.028 2.688 0 3.848-2.339 4.695-4.566
                ...
                <a
                    href='mailto:nahuel.chaves@gmail.com'
                    target='_blank'
                    className='ml-6 text-gray-400 hover:text-gray-500'
                >
